...
{
    /// <summary>
    /// Klasa reprezentująca pojedynczy neuron sieci neuronowych.
    /// </summary>
    public class Neuron : IPerceptron
    {
        /// <summary>
        /// Tworzy nowy Neuron z podaną ilością inputów
        /// </summary>
        /// <param name="inputs">Liczba inputów.</param>
        /// <param name="activationFunction">Funkcja aktywacyjna.</param>
        public Neuron(int inputs, ActivationFunctionHandler activationFunction)
        {
            Inputs = inputs;
        ...
        /// <summary>
        /// Wagi odpowiadające inputom.
        /// </summary>
        public float[] Weights { get; private set; }
        /// <summary>
        /// Liczba inputów jaką neuron może przyjąć.
        /// </summary>
        public int Inputs { get; private set; }
        /// <summary>
        /// Wskazuje na to czy bias ma być dodany.
        /// </summary>
        ...
        public float GetGuess(float[] inputs)
        {
            ...
            {
                throw new Exception("Liczba inputów jaką otrzymano jest niezgodna z liczbą inputów jaką neuron może przyjąć.");
            }
        ...
        public float[] ModifyWeightsByError(float error, float[] inputs)
        {
            ...
            float[] weightsChange = new float[Inputs];
